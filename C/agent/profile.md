...
- **Historia e historiografía** (A3, A5, B5, B6): Carr, Koselleck, Conrad,
  Said, Fanon, Arendt, Assmann + historia alemana y colonial. Nivel de
  estudiante/graduada de historia — el binder "AP History" lo confirma.
...
4. Wildcard: japonesas contemporáneas (tiene Murata, Aoyama, Ishiguro).
